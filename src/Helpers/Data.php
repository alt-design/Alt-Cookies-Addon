 ...
 * @author   Ben Harvey <ben@alt-design.net>, Natalie Higgins <natalie@alt-design.net>, Benammi Swift <benammi@alt-design.net>
...
class Data
{
    ...
    public function setAll($data)
    {
        ...
        $this->manager->disk()->put('content/alt-cookies/' . $this->type . '.yaml', Yaml::dump($this->data));
    }
