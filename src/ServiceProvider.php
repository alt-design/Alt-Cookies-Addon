...
class ServiceProvider extends AddonServiceProvider
{
    ...
    public function addToNav() : self
    {
        Nav::extend(function ($nav) {
            $nav->content('Alt Cookies')
                ->section('Tools')
                ->route('alt-cookies-addon.index')
                ->can('view alt-cookies-addon')
                ->children([
                    'Settings' => cp_route('alt-cookies-addon.index'),
                    'Scan' => cp_route('alt-cookies-addon.scan.index'),
                ])
    ...
    {
        Permission::register('view alt-cookies-addon')
            ->label('View Alt Cookies Settings');
        return $this;
    }
